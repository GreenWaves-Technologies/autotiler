...

{
    ...
    for (unsigned int of = First; of < Last; of++)
    {
        ...
        v4s B = (v4s)
        {
            Bias[of], Bias[of], Bias[of], Bias[of]
        };
...

{
    ...
    for (i = 0; i < (Iter / 2); i++) VectOut[i] = (v2s)
    {
        Bias, Bias
    };
...

{
    ...
    for (i = 0; i < (Iter / 4); i++) VectOut[i] = (v4s)
    {
        Bias, Bias, Bias, Bias
    };
...

{
    ...
    for (unsigned int i = 0; i < ((W * H) / 4); i++)
    {
        v2s X = gap8_max2(VectIn[2 * i], ((v2s)
        {
            0, 0
        }));
        v2s Y = gap8_max2(VectIn[2 * i + 1], ((v2s)
        {
            0, 0
        }));
        VectOut[2 * i] = X;
