...

{
    if (DoReLU)
    {
        for (unsigned int i = Ho_F; i < Ho_L; i++)
        {
            ...
            for (unsigned int j = Wo_F; j < Wo_L; j++)
            {
                int S = gap8_dotp2(Line1[j], ((v2s)
                {
                    1, 1
                }));
                Out[Wo * i + j] = Max(0, gap8_sumdotp2(Line2[j], ((v2s)
                {
                    1, 1
                }), S) >> 2);
    ...
    else
    {
        for (unsigned int i = Ho_F; i < Ho_L; i++)
        {
            ...
            for (unsigned int j = Wo_F; j < Wo_L; j++)
            {
                ...
                Out[Wo * i + j] = gap8_sumdotp2(Line2[j], ((v2s)
                {
                    1, 1
                }), S) >> 2;
            }
            ...
            for (unsigned int w = Wo_F; w < Wo_L; w++)
            {
                for (unsigned int h = Ho_F; h < Ho_L; h++)
                {
                    ...
                    for (unsigned int i = 0; i < Fh; i++)
                    {
                        ...
                        for (unsigned int j = 0; j < (Fw / 2); j++) S = gap8_sumdotp2(Line[j], ((v2s)
                        {
                            1, 1
                        }), S);
...

{
    ...
    if (PadB)
    {
        ...
        if (Iter & 0x1)
        {
            v4s M = gap8_max4(Line1[Iter / 2], ((v4s)
            {
                0, 0, 0, 0
            }));
...

{
    if (DoReLU)
    {
        for (unsigned int i = Ho_F; i < Ho_L; i++)
        {
            ...
            for (unsigned int j = Wo_F; j < Wo_L; j++)
            {
                int S = gap8_dotp4((v4s)(int)Line1[j], ((v4s)
                {
                    1, 1, 0, 0
                }));
                Out[Wo * i + j] = Max(0, gap8_sumdotp4((v4s)(int)Line2[j], ((v4s)
                {
                    1, 1, 0, 0
                }), S) >> 2);
    ...
    else
    {
        for (unsigned int i = Ho_F; i < Ho_L; i++)
        {
            ...
            for (unsigned int j = Wo_F; j < Wo_L; j++)
            {
                ...
                Out[Wo * i + j] = gap8_sumdotp4((v4s)(int)Line2[j], ((v4s)
                {
                    1, 1, 0, 0
                }), S) >> 2;
            }
            ...
            for (unsigned int w = Wo_F; w < Wo_L; w++)
            {
                for (unsigned int h = Ho_F; h < Ho_L; h++)
                {
                    ...
                    for (unsigned int i = 0; i < Fh; i++)
                    {
                        ...
                        for (unsigned int j = 0; j < (Fw / 2); j++) S = gap8_sumdotp4((v4s)(int)Line[j], ((v4s)
                        {
                            1, 1, 0, 0
                        }), S);
                        S += In[(h * Stride - PadT + i) * W + (w * Stride - PadL) + Fw - 1];
...
void KerParPoolNxMStrideSxSy_fps(KerParReLUPool_fps_T *Arg)
...
void KerParPoolNxMStrideSxSy_fp(KerParReLUPool_fp_T *Arg)
