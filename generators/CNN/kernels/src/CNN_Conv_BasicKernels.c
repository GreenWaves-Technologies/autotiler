...

{
    ...
    if (CoreCountDynamic) NCore = ActiveCore;
    else NCore = gap8_ncore();
...
)
{
    ...
    if (FilterConf)
    {
        C0 = (v4s) (int) * ((unsigned short *) (Filter + 0 * 3 + 0));
        C1 = (v4s) (int) * ((unsigned short *) (Filter + 1 * 3 + 0));
        C2 = (v4s) (int) * ((unsigned short *) (Filter + 2 * 3 + 0));
    }
    else
    {
        C0 = (v4s) (int) * ((unsigned short *) (Filter + 0 * 3 + 1));
        C1 = (v4s) (int) * ((unsigned short *) (Filter + 1 * 3 + 1));
        C2 = (v4s) (int) * ((unsigned short *) (Filter + 2 * 3 + 1));
    }
    if (Ho_F == 1)
    {
        PtIn = In;
    ...
    for (unsigned int i = Ho_F; i < Ho_L; i++)
    {
        ...
        V2 = *((v4s *) PtIn);
        PtIn += W;
        Acc = gap8_sumdotp4(V0, C0, Acc);
        Acc = gap8_sumdotp4(V1, C1, Acc);
        Acc = gap8_sumdotp4(V2, C2, Acc);
        *PtOut =  gap8_clip(gap8_roundnorm_reg(Acc, Norm), 7);
        PtOut += Wo;
        V0 = V1;
        V1 = V2;
...

{
    ...
    case 0:
        ...
        C4 = (v4s)
        {
            Filter[2 * 5 + 4], Filter[3 * 5 + 4], Filter[4 * 5 + 4], 0
        };
        break;
    case 1:
        C0 = *((v4s *) &Filter[1 * 5 + 0]);
        ...
        C4 = (v4s)
        {
            Filter[1 * 5 + 4], Filter[2 * 5 + 4], Filter[3 * 5 + 4], Filter[4 * 5 + 4]
        };
        break;
    case 2:
        C0 = *((v4s *) &Filter[0 * 5 + 0]);
        ...
        C4 = (v4s)
        {
            Filter[0 * 5 + 4], Filter[1 * 5 + 4], Filter[2 * 5 + 4], Filter[3 * 5 + 4]
        };
        break;
    case 3:
        C0 = (v4s)
        ...
        C4 = (v4s)
        {
            0, Filter[0 * 5 + 4], Filter[1 * 5 + 4], Filter[2 * 5 + 4]
        };
        break;
    }
    V0 = *((v4s *) (PtIn + 0 * W + 0));
    ...
    for (unsigned int i = Wo_F; i < Wo_L; i++)
    {
        ...
        *PtOut = gap8_clip(gap8_roundnorm_reg(Acc, Norm), 7);
        PtOut++;
        V0 = __builtin_shuffle(V0, (v4s)(int)V4, (v4s)
        {
            1, 2, 3, 4
        });
        V1 = __builtin_shuffle(V1, (v4s)(int)V4, (v4s)
        {
            1, 2, 3, 5
        });
        V2 = __builtin_shuffle(V2, (v4s)(int)V4, (v4s)
        {
            1, 2, 3, 6
        });
        V3 = __builtin_shuffle(V3, (v4s)(int)V4, (v4s)
        {
            1, 2, 3, 7
        });
    }
        ...
        for (unsigned int h = 0; h < Ho_F; h++)
        {
            ...
            for (unsigned int w = Wo_F; w < Wo_L; w++)
            {
                ...
                for (unsigned int i = Fh_min; i < Fh_max; i++)
                    for (unsigned int j = 0; j < Fw; j++) Acc += In[(h * Stride - PadTOrg + i) * W + (w * Stride - PadLOrg + j)] * Filter[Fh * i + j];
    ...
    if (PadT)   /* Top */
    {
        ...
        for (unsigned int h = 0; h < Ho_F; h++)
        {
            ...
            for (unsigned int w = Wo_F; w < Wo_L; w++)
            {
                int Acc = Out[Wo * h + w] << Norm;
                for (unsigned int i = Fh_min; i < Fh_max; i++)
                    for (unsigned int j = 0; j < Fw; j++) Acc += In[(h * StrideY - PadTOrg + i) * W + (w * StrideX - PadLOrg + j)] * Filter[Fh * i + j];
                Out[Wo * h + w] = gap8_clip(gap8_roundnorm_reg(Acc, Norm), 7);
            }
            ht -= StrideY;
            hb -= StrideY;
...

{
    ...
    if (FilterConf)
    {
        X = *((v2s *) &Filter[0 * 3 + 0]);
        Y = *((v2s *) &Filter[1 * 3 + 0]);
        C0 = __builtin_shuffle(X, Y, (v2s)
        {
            0, 2
        });
        C1 = __builtin_shuffle(X, Y, (v2s)
        {
            1, 3
        });
    ...
    else
    {
        ...
        C2 = gap8_pack2(Filter[5], Filter[8]);
    }
    X = *((v2s *) (PtIn + 0 * W + 0));
    Y = *((v2s *) (PtIn + 1 * W + 0));
    V0 = __builtin_shuffle(X, Y, (v2s)
    {
        0, 2
    });
    V1 = __builtin_shuffle(X, Y, (v2s)
    {
        1, 3
    });
    PtIn += 2;
...

{
    ...
    if (FilterConf)
    {
        Cv0 =  *((v2s *) &Filter[0 * 3 + 0]);
        C0 = Filter[0 * 3 + 2];
        Cv1 =  *((v2s *) &Filter[1 * 3 + 0]);
        C1 = Filter[1 * 3 + 2];
    }
    else
    {
        Cv0 =  *((v2s *) &Filter[1 * 3 + 0]);
        C0 = Filter[1 * 3 + 2];
        Cv1 =  *((v2s *) &Filter[2 * 3 + 0]);
        C1 = Filter[2 * 3 + 2];
    }
    for (unsigned int w = Wo_F; w < Wo_L; w++)
    {
        ...
        int Acc = *PtOut << Norm;
#ifdef ASM_OPT
        asm VOL("p.lw %0,%2(%1!)":"=r"(Iv0), "+r"(PtI):"i"(4):"memory");
        asm VOL("p.lh %0,%2(%1!)":"=r"(I), "+r"(PtI):"r"(2*W-2*(Fw-1)):"memory");
        Acc = gap8_sumdotp2(Iv0, Cv0, Acc);
        Acc += I * C0;
        asm VOL("p.lw %0,%2(%1!)":"=r"(Iv0), "+r"(PtI):"i"(4):"memory");
        asm VOL("p.lh %0,%2(%1!)":"=r"(I), "+r"(PtI):"r"(2*W-2*(Fw-1)):"memory");
        Acc = gap8_sumdotp2(Iv0, Cv1, Acc);
        Acc += I * C1;
...
)
{
    ...
    case 0: // [0..4 x 0..4] => [2..4 x 0..4]
        C0 = *((v2s *) (Filter + 0 * 5 + 2));
        C1 = gap8_pack2(Filter[0 * 5 + 4], 0);
        C2 = *((v2s *) (Filter + 1 * 5 + 2));
        C3 = gap8_pack2(Filter[1 * 5 + 4], 0);
        C4 = *((v2s *) (Filter + 2 * 5 + 2));
        C5 = gap8_pack2(Filter[2 * 5 + 4], 0);
        C6 = *((v2s *) (Filter + 3 * 5 + 2));
        C7 = gap8_pack2(Filter[3 * 5 + 4], 0);
        C8 = *((v2s *) (Filter + 4 * 5 + 2));
        C9 = gap8_pack2(Filter[4 * 5 + 4], 0);
        break;
    case 1: // [0..4 x 0..4] => [1..4 x 0..4]
        C0 = *((v2s *) (Filter + 0 * 5 + 1));
        C1 = *((v2s *) (Filter + 0 * 5 + 3));
    ...
    case 2: // [0..4 x 0..4] => [0..3 x 0..4]
        ...
        break;
    case 3: // [0..4 x 0..4] => [0..2 x 0..4]
        C0 = gap8_pack2(0, Filter[0 * 5 + 0]);
        C1 = *((v2s *) (Filter + 0 * 5 + 1));
        C2 = gap8_pack2(0, Filter[1 * 5 + 0]);
        C3 = *((v2s *) (Filter + 1 * 5 + 1));
        C4 = gap8_pack2(0, Filter[2 * 5 + 0]);
        C5 = *((v2s *) (Filter + 2 * 5 + 1));
        C6 = gap8_pack2(0, Filter[3 * 5 + 0]);
        C7 = *((v2s *) (Filter + 3 * 5 + 1));
        C8 = gap8_pack2(0, Filter[4 * 5 + 0]);
        C9 = *((v2s *) (Filter + 4 * 5 + 1));
        break;
    }
    ...
    else
    {
        ...
        PtOut = Out + Ho_F * Wo;
#ifdef ASM_OPT
        asm VOL("p.lw %0,%2(%1!)":"=r"(V0), "+r"(PtIn):"i"(4):"memory");
        asm VOL("p.lw %0,%2(%1!)":"=r"(V1), "+r"(PtIn):"r"(Off0):"memory");
        asm VOL("p.lw %0,%2(%1!)":"=r"(V2), "+r"(PtIn):"i"(4):"memory");
        asm VOL("p.lw %0,%2(%1!)":"=r"(V3), "+r"(PtIn):"r"(Off0):"memory");
#else
        V0 = *((v2s *) PtIn);
        PtIn += 2;
        V1 = *((v2s *) PtIn);
...
#ifdef ASM_OPT
    asm VOL("p.lw %0,%2(%1!)":"=r"(V4), "+r"(PtIn):"i"(4):"memory");
    asm VOL("p.lw %0,%2(%1!)":"=r"(V5), "+r"(PtIn):"r"(Off0):"memory");
    asm VOL("p.lw %0,%2(%1!)":"=r"(V6), "+r"(PtIn):"i"(4):"memory");
    asm VOL("p.lw %0,%2(%1!)":"=r"(V7), "+r"(PtIn):"r"(Off0):"memory");
#else
    V4 = *((v2s *) PtIn);
    PtIn += 2;
    V5 = *((v2s *) PtIn);
    ...
    for (unsigned int i = Ho_F; i < Ho_L; i++)
    {
        int Acc = *PtOut << Norm;
#ifdef ASM_OPT1
        asm VOL("p.lw %0,%2(%1!)":"=r"(V8), "+r"(PtIn):"i"(4):"memory");
        asm VOL("p.lw %0,%2(%1!)":"=r"(V9), "+r"(PtIn):"r"(Off0):"memory");
#else
        V8 = *((v2s *) PtIn);
        PtIn += 2;
        V9 = *((v2s *) PtIn);
        ...
        Acc = gap8_sumdotp2(V1, C1, Acc);
        Acc = gap8_sumdotp2(V2, C2, Acc);
        Acc = gap8_sumdotp2(V3, C3, Acc);
        Acc = gap8_sumdotp2(V4, C4, Acc);
        Acc = gap8_sumdotp2(V5, C5, Acc);
        Acc = gap8_sumdotp2(V6, C6, Acc);
        Acc = gap8_sumdotp2(V7, C7, Acc);
        Acc = gap8_sumdotp2(V8, C8, Acc);
        Acc = gap8_sumdotp2(V9, C9, Acc);
        Acc = gap8_clip(gap8_roundnorm_reg(Acc, Norm), 15);
#ifdef ASM_OPT
...

{
    ...
    case 0:
        ...
        X = *((v2s *) &Filter[2 * 5 + 2]);
        Y = *((v2s *) &Filter[3 * 5 + 2]);
        C2 = __builtin_shuffle(X, Y, (v2s)
        {
            0, 2
        });
        C3 = __builtin_shuffle(X, Y, (v2s)
        {
            1, 3
        });
        C4 = gap8_pack2(Filter[14], Filter[19]);
        C5 = gap8_pack2(Filter[20], 0);
        C6 = gap8_pack2(Filter[21], 0);
        C7 = gap8_pack2(Filter[22], 0);
        C8 = gap8_pack2(Filter[23], 0);
        C9 = gap8_pack2(Filter[24], 0);
        break;
    case 1:
        X = *((v2s *) &Filter[1 * 5 + 0]);
        Y = *((v2s *) &Filter[2 * 5 + 0]);
        ...
        X = *((v2s *) &Filter[3 * 5 + 0]);
        Y = *((v2s *) &Filter[4 * 5 + 0]);
        C5 = __builtin_shuffle(X, Y, (v2s)
        {
            0, 2
        });
        C6 = __builtin_shuffle(X, Y, (v2s)
        {
            1, 3
        });
        X = *((v2s *) &Filter[3 * 5 + 2]);
        Y = *((v2s *) &Filter[4 * 5 + 2]);
        C7 = __builtin_shuffle(X, Y, (v2s)
        {
            0, 2
        });
        C8 = __builtin_shuffle(X, Y, (v2s)
        {
            1, 3
        });
    ...
    case 2:
        ...
        break;
    case 3:
        C0 = gap8_pack2(0, Filter[0]);
        C1 = gap8_pack2(0, Filter[1]);
        C2 = gap8_pack2(0, Filter[2]);
        C3 = gap8_pack2(0, Filter[3]);
        C4 = gap8_pack2(0, Filter[4]);
    ...
    V3 = __builtin_shuffle(X, Y, (v2s)
    {
        1, 3
    });
    X = *((v2s *) (PtIn + 2 * W + 0));
    Y = *((v2s *) (PtIn + 3 * W + 0));
    V5 = __builtin_shuffle(X, Y, (v2s)
    {
        0, 2
    });
    V6 = __builtin_shuffle(X, Y, (v2s)
    {
        1, 3
    });
    X = *((v2s *) (PtIn + 2 * W + 2));
    Y = *((v2s *) (PtIn + 3 * W + 2));
    V7 = __builtin_shuffle(X, Y, (v2s)
    {
        0, 2
    });
    V8 = __builtin_shuffle(X, Y, (v2s)
    {
        1, 3
    });
    PtIn += 4;
...

{
    ...
    {
    case 0:
        Cv0 = *((v2s *)(Filter + 2 * 5 + 0));
        Cv1 = *((v2s *)(Filter + 2 * 5 + 2));
        C0 = Filter[2 * 5 + 4];
        Cv2 = *((v2s *)(Filter + 3 * 5 + 0));
        Cv3 = *((v2s *)(Filter + 3 * 5 + 2));
        C1 = Filter[3 * 5 + 4];
        Cv4 = *((v2s *)(Filter + 4 * 5 + 0));
        Cv5 = *((v2s *)(Filter + 4 * 5 + 2));
        C2 = Filter[4 * 5 + 4];
        Cv6 = (v2s)
        {
            0, 0
    ...
    case 1:
        if (((H + PadT) & 0x1) == 0)
        {
            Cv0 = *((v2s *)(Filter + 0 * 5 + 0));
            Cv1 = *((v2s *)(Filter + 0 * 5 + 2));
            C0 = Filter[0 * 5 + 4];
            Cv2 = *((v2s *)(Filter + 1 * 5 + 0));
            Cv3 = *((v2s *)(Filter + 1 * 5 + 2));
            C1 = Filter[1 * 5 + 4];
            Cv4 = *((v2s *)(Filter + 2 * 5 + 0));
            Cv5 = *((v2s *)(Filter + 2 * 5 + 2));
            C2 = Filter[2 * 5 + 4];
            Cv6 = *((v2s *)(Filter + 3 * 5 + 0));
            Cv7 = *((v2s *)(Filter + 3 * 5 + 2));
            C3 = Filter[3 * 5 + 4];
        }
        else
        {
            ...
            C0 = 0;
            Cv2 = *((v2s *)(Filter + 0 * 5 + 0));
            Cv3 = *((v2s *)(Filter + 0 * 5 + 2));
            C1 = Filter[0 * 5 + 4];
            Cv4 = *((v2s *)(Filter + 1 * 5 + 0));
            Cv5 = *((v2s *)(Filter + 1 * 5 + 2));
            C2 = Filter[1 * 5 + 4];
            Cv6 = *((v2s *)(Filter + 2 * 5 + 0));
            Cv7 = *((v2s *)(Filter + 2 * 5 + 2));
            C3 = Filter[2 * 5 + 4];
        }
        break;
    }
...
#ifdef ASM_OPT
        asm VOL("p.lw %0,%2(%1!)":"=r"(Iv0), "+r"(PtI):"i"(4):"memory");
        asm VOL("p.lw %0,%2(%1!)":"=r"(Iv1), "+r"(PtI):"i"(4):"memory");
        asm VOL("p.lh %0,%2(%1!)":"=r"(I), "+r"(PtI):"r"(2*W-2*(Fw-1)):"memory");
        Acc = gap8_sumdotp2(Iv0, Cv0, Acc);
        Acc = gap8_sumdotp2(Iv1, Cv1, Acc);
        Acc += I * C0;
        asm VOL("p.lw %0,%2(%1!)":"=r"(Iv0), "+r"(PtI):"i"(4):"memory");
        asm VOL("p.lw %0,%2(%1!)":"=r"(Iv1), "+r"(PtI):"i"(4):"memory");
        asm VOL("p.lh %0,%2(%1!)":"=r"(I), "+r"(PtI):"r"(2*W-2*(Fw-1)):"memory");
        Acc = gap8_sumdotp2(Iv0, Cv2, Acc);
        Acc = gap8_sumdotp2(Iv1, Cv3, Acc);
        Acc += I * C1;
        asm VOL("p.lw %0,%2(%1!)":"=r"(Iv0), "+r"(PtI):"i"(4):"memory");
        asm VOL("p.lw %0,%2(%1!)":"=r"(Iv1), "+r"(PtI):"i"(4):"memory");
        asm VOL("p.lh %0,%2(%1!)":"=r"(I), "+r"(PtI):"r"(2*W-2*(Fw-1)):"memory");
        Acc = gap8_sumdotp2(Iv0, Cv4, Acc);
        Acc = gap8_sumdotp2(Iv1, Cv5, Acc);
        Acc += I * C2;
        asm VOL("p.lw %0,%2(%1!)":"=r"(Iv0), "+r"(PtI):"i"(4):"memory");
        asm VOL("p.lw %0,%2(%1!)":"=r"(Iv1), "+r"(PtI):"i"(4):"memory");
        asm VOL("p.lh %0,%2(%1!)":"=r"(I), "+r"(PtI):"r"(2*W-2*(Fw-1)):"memory");
        Acc = gap8_sumdotp2(Iv0, Cv6, Acc);
        Acc = gap8_sumdotp2(Iv1, Cv7, Acc);
        Acc += I * C3;
        Acc = gap8_clip(gap8_roundnorm_reg(Acc, Norm), 15);
        asm VOL("p.sh %1,%2(%0!)"  : "+r" (PtOut) : "r" (Acc), "i" (2) : "memory");
#else
...

{
    ...
    if (PadL && (Wo_F == 1)) KerConv2x1from3x1StrideNx1_V_fp(In, W, PadTOrg, Wo, Ho, Ho_F, Ho_L, Norm, Out, Filter, 0);
    if (PadR && ((Wo - Wo_L) == 1)) KerConv2x1from3x1StrideNx1_V_fp(In + Wo_L * Stride - PadLOrg, W, PadTOrg, Wo, Ho, Ho_F, Ho_L, Norm, Out + Wo - 1, Filter, 1);
}
...

{
    ...
    if (PadT && (Ho_F == 1)) KerConv1x2from1x3Stride1xN_H_fp(In, W, PadLOrg, Wo, Wo_F, Wo_L, Norm, Out + Wo_F, Filter, 0);
    if (PadB && ((Ho - Ho_L) == 1)) KerConv1x2from1x3Stride1xN_H_fp(In + (Ho_L * Stride - PadTOrg)*W, W, PadLOrg, Wo, Wo_F, Wo_L, Norm, Out + Ho_L * Wo + Wo_F, Filter, 1);
}
...

{
    ...
    if (PadL && (Wo_F == 2))
    {
        KerConv4x1from5x1StrideNx1_V_fp(In, W, PadOrg, Pad, Wo, Ho, Ho_F, Ho_L, Norm, Out, Filter, 0);
        KerConv4x1from5x1StrideNx1_V_fp(In, W, PadOrg, Pad, Wo, Ho, Ho_F, Ho_L, Norm, Out + 1, Filter, 1);
    }
    if (PadR && ((Wo - Wo_L) == 2))
    {
        KerConv4x1from5x1StrideNx1_V_fp(In + Wo_L * Stride - PadLOrg, W, PadOrg, Pad, Wo, Ho, Ho_F, Ho_L, Norm, Out + Wo - 2, Filter, 2);
        KerConv4x1from5x1StrideNx1_V_fp(In + Wo_L * Stride - PadLOrg, W, PadOrg, Pad, Wo, Ho, Ho_F, Ho_L, Norm, Out + Wo - 1, Filter, 3);
    }
}
...

{
    ...
    if (PadT && (Ho_F == 2))
    {
        KerConv1x4from1x5Stride1xN_H_fp(In, W, PadLOrg, Wo, Wo_F, Wo_L, Norm, Out + Wo_F, Filter, 0);
        KerConv1x4from1x5Stride1xN_H_fp(In, W, PadLOrg, Wo, Wo_F, Wo_L, Norm, Out + Wo_F + Wo, Filter, 1);
    }
    if (PadB && ((Ho - Ho_L) == 2))
    {
        KerConv1x4from1x5Stride1xN_H_fp(In + (Ho_L * Stride - PadTOrg)*W, W, PadLOrg, Wo, Wo_F, Wo_L, Norm, Out + Ho_L * Wo + Wo_F, Filter, 2);
        KerConv1x4from1x5Stride1xN_H_fp(In + (Ho_L * Stride - PadTOrg)*W, W, PadLOrg, Wo, Wo_F, Wo_L, Norm, Out + (Ho_L + 1)*Wo + Wo_F, Filter, 3);
    }
}
...

{
    ...
    if (PadL && (Wo_F == 1)) KerConv2x1from3x1StrideNx1_V_fps(In, W, PadTOrg, Wo, Ho, Ho_F, Ho_L, Norm, Out, Filter, 0);
    if (PadR && ((Wo - Wo_L) == 1)) KerConv2x1from3x1StrideNx1_V_fps(In + Wo_L * Stride - PadLOrg, W, PadTOrg, Wo, Ho, Ho_F, Ho_L, Norm, Out + Wo - 1, Filter, 1);
}
...

{
    ...
    if (PadT && (Ho_F == 1)) KerConv1x2from1x3Stride1xN_H_fps(In, W, PadLOrg, Wo, Wo_F, Wo_L, Norm, Out + Wo_F, Filter, 0);
    if (PadB && ((Ho - Ho_L) == 1)) KerConv1x2from1x3Stride1xN_H_fps(In + (Ho_L * Stride - PadTOrg)*W, W, PadLOrg, Wo, Wo_F, Wo_L, Norm, Out + Ho_L * Wo + Wo_F, Filter, 1);
}
...

{
    ...
    if (PadL && (Wo_F == 2))
    {
        KerConv4x1from5x1StrideNx1_V_fps(In, W, PadOrg, Pad, Wo, Ho, Ho_F, Ho_L, Norm, Out, Filter, 0);
        KerConv4x1from5x1StrideNx1_V_fps(In, W, PadOrg, Pad, Wo, Ho, Ho_F, Ho_L, Norm, Out + 1, Filter, 1);
    }
    if (PadR && ((Wo - Wo_L) == 2))
    {
        KerConv4x1from5x1StrideNx1_V_fps(In + Wo_L * Stride - PadLOrg, W, PadOrg, Pad, Wo, Ho, Ho_F, Ho_L, Norm, Out + Wo - 2, Filter, 2);
        KerConv4x1from5x1StrideNx1_V_fps(In + Wo_L * Stride - PadLOrg, W, PadOrg, Pad, Wo, Ho, Ho_F, Ho_L, Norm, Out + Wo - 1, Filter, 3);
    }
}
...

{
    ...
    if (PadT && (Ho_F == 2))
    {
        KerConv1x4from1x5Stride1xN_H_fps(In, W, PadLOrg, Wo, Wo_F, Wo_L, Norm, Out + Wo_F, Filter, 0);
        KerConv1x4from1x5Stride1xN_H_fps(In, W, PadLOrg, Wo, Wo_F, Wo_L, Norm, Out + Wo_F + Wo, Filter, 1);
    }
    if (PadB && ((Ho - Ho_L) == 2))
    {
        KerConv1x4from1x5Stride1xN_H_fps(In + (Ho_L * Stride - PadTOrg)*W, W, PadLOrg, Wo, Wo_F, Wo_L, Norm, Out + Ho_L * Wo + Wo_F, Filter, 2);
        KerConv1x4from1x5Stride1xN_H_fps(In + (Ho_L * Stride - PadTOrg)*W, W, PadLOrg, Wo, Wo_F, Wo_L, Norm, Out + (Ho_L + 1)*Wo + Wo_F, Filter, 3);
    }
}
...

{
    ...
    for (unsigned int h = Ho_F; h < Ho_L; h++)
    {
        ...
        for (unsigned int w = Wo_F; w < Wo_L; w++)
        {
            ...
            PtI += Stride;
            Acc += I * C0;
            *PtO = gap8_clip(gap8_roundnorm_reg(Acc, Norm), 7);
            PtO++;
        }
...

{
    ...
    for (unsigned int w = Wo_F; w < Wo_L; w++)
    {
        ...
        {
            int Acc = *PtO << Norm;
            unsigned int X0 = *(unsigned char *) PtI;
            PtI = ((signed char *)PtI + W);
            unsigned int X1 = *(unsigned char *) PtI;
            PtI = ((signed char *)PtI + W);
            X0 = X0 | (X1 << 8);
            V0 = __builtin_shuffle(V0, (v4s) X0, Mask);
            Acc = gap8_sumdotp4(V0, C0, Acc);
...

{
    ...
    for (unsigned int w = Wo_F; w < Wo_L; w++)
    {
        ...
        for (unsigned int h = Ho_F; h < Ho_L; h++)
        {
            ...
            PtI = (v4s *) ((signed char *)PtI + W);
            V2 = *PtI;
            PtI = (v4s *) ((signed char *)PtI + (Stride - 2) * W);
            Acc = gap8_sumdotp4(V0, C0, Acc);
            Acc = gap8_sumdotp4(V1, C1, Acc);
            Acc = gap8_sumdotp4(V2, C2, Acc);
            Acc = gap8_clip(gap8_roundnorm_reg(Acc, Norm), 7);
...

{
    ...
    for (unsigned int w = Wo_F; w < Wo_L; w++)
    {
        ...
        int x0, x1, x2, x3;
#ifdef ASM_OPT
        asm VOL("p.lw %0,%2(%1!)":"=r"(V0), "+r"(PtI):"i"(4):"memory");
        asm VOL("p.lb %0,%2(%1!)":"=r"(x0), "+r"(PtI):"r"(W-4):"memory");
        asm VOL("p.lw %0,%2(%1!)":"=r"(V1), "+r"(PtI):"i"(4):"memory");
        asm VOL("p.lb %0,%2(%1!)":"=r"(x1), "+r"(PtI):"r"(W-4):"memory");
        asm VOL("p.lw %0,%2(%1!)":"=r"(V2), "+r"(PtI):"i"(4):"memory");
        asm VOL("p.lb %0,%2(%1!)":"=r"(x2), "+r"(PtI):"r"(W-4):"memory");
        asm VOL("p.lw %0,%2(%1!)":"=r"(V3), "+r"(PtI):"i"(4):"memory");
        asm VOL("p.lb %0,%2(%1!)":"=r"(x3), "+r"(PtI):"r"(W-4):"memory");
#else
        V0 = *PtI++;
        x0 = *((signed char *) PtI);
        PtI = (v4s *) ((signed char *)PtI + W - 4);
        ...
        for (unsigned int h = Ho_F; h < Ho_L; h++)
        {
            int S = *PtO << N;
#ifdef ASM_OPT
            asm VOL("p.lw %0,%2(%1!)":"=r"(V4), "+r"(PtI):"i"(4):"memory");
            asm VOL("p.lb %0,%2(%1!)":"=r"(V6), "+r"(PtI):"r"(W-4):"memory");
#else
            V4 = *PtI++;
            V6 = (v4s) (int) (*((signed char *) PtI));
            PtI = (v4s *) ((signed char *)PtI + W - 4);
#endif
            S = gap8_sumdotp4(V0,  C0,  S);
...

{
    ...
    for (unsigned int w = Wo_F; w < Wo_L; w++)
    {
        ...
        for (unsigned int h = Ho_F; h < Ho_L; h++)
        {
            ...
            V4 = *PtI++;
            V6 = (v4s) (int) (*((signed char *) PtI));
            PtI = (v4s *) ((signed char *)PtI + (Stride - 4) * W - 4);
...
)
{
    ...
    for (unsigned int h = Ho_F; h < Ho_L; h++)
    {
        for (unsigned int w = Wo_F; w < Wo_L; w++)
        {
            ...
            for (unsigned int i = 0; i < Fh; i++)
            {
                for (unsigned int j = 0; j < Fw; j++) Acc += In[(h * StrideY - PadT + i) * W + (w * StrideX - PadL + j)] * Filter[Fh * i + j];
            }
            *PtO = gap8_clip(gap8_roundnorm_reg(Acc, Norm), 7);
            PtO++;
        }
...

{
    ...
    for (unsigned int w = Wo_F; w < Wo_L; w++)
    {
...
#ifdef ASM_OPT
        asm VOL("p.lw %0,%2(%1!)":"=r"(V0), "+r"(PtI):"i"(4):"memory");
        asm VOL("p.lh %0,%2(%1!)":"=r"(V2), "+r"(PtI):"r"(Off0):"memory");
        asm VOL("p.lw %0,%2(%1!)":"=r"(V1), "+r"(PtI):"i"(4):"memory");
        asm VOL("p.lh %0,%2(%1!)":"=r"(V3), "+r"(PtI):"r"(Off0):"memory");
        V2 = __builtin_shuffle(V2, V3, (v2s)
        {
            0, 2
        });
        ...
        for (unsigned int h = Ho_F; h < Ho_L; h++)
        {
...
#ifdef ASM_OPT
            asm VOL ("p.lw %0,%2(%1!)" : "=r" (V3), "+r" (PtI) : "i" (4) : "memory");
            asm VOL ("p.lh %0,%2(%1!)" : "=r" (V4), "+r" (PtI) : "r" (Off0) : "memory");
#else
            V3 = *PtI++;
            V4 = *PtI;
            PtI = (v2s *) ((short int *)PtI + W - 2);
            ...
            V0 = V1;
            V1 = V3;
            V2 = __builtin_shuffle(V2, V4, (v2s)
            {
                1, 2
            });
#ifdef ASM_OPT
...

{
    ...
    for (unsigned int w = Wo_F; w < Wo_L; w++)
    {
...
#ifdef ASM_OPT
        asm VOL("p.lw %0,%2(%1!)":"=r"(V0), "+r"(PtI):"i"(4):"memory");
        asm VOL("p.lh %0,%2(%1!)":"=r"(V1), "+r"(PtI):"r"(Off0):"memory");
#else
        V0 = *PtI++;
        V1 = *PtI;
        PtI = (v2s *) ((short int *)PtI + W - 2);
        ...
        for (unsigned int h = Ho_F; h < Ho_L; h++)
        {
            ...
            asm VOL ("p.lh %0,%2(%1!)" : "=r" (V3), "+r" (PtI) : "r" (Off0) : "memory");
            asm VOL ("p.lw %0,%2(%1!)" : "=r" (V4), "+r" (PtI) : "i" (4) : "memory");
            asm VOL ("p.lh %0,%2(%1!)" : "=r" (V5), "+r" (PtI) : "r" (Off0) : "memory");
#else
            V2 = *PtI++;
            V3 = *PtI;
            PtI = (v2s *) ((short int *)PtI + W - 2);
...
)
{
    ...
    for (unsigned int h = Ho_F; h < Ho_L; h++)
    {
        ...
        for (unsigned int w = Wo_F; w < Wo_L; w++)
        {
            ...
            V1 = __builtin_shuffle(V1, (v2s) V2, Mask);
            V2 = *((short int *) PtI);
            PtI = (v2s *) ((short int *)PtI + 1);
            Acc = gap8_sumdotp2(V0, C0, Acc);
            Acc = gap8_sumdotp2(V1, C1, Acc);
...

{
    ...
    for (unsigned int w = Wo_F; w < Wo_L; w++)
    {
        ...
        int X, Y;
#ifdef ASM_OPT
        asm("p.lw %0,%2(%1!)" : "=r" (V0), "+r" (PtI) : "i" (4) : );
        asm("p.lw %0,%2(%1!)" : "=r" (V1), "+r" (PtI) : "i" (4) : );
        asm("p.lh %0,%2(%1!)" : "=r" (X), "+r" (PtI) : "r" (Off0) : );
        asm("p.lw %0,%2(%1!)" : "=r" (V2), "+r" (PtI) : "i" (4) : );
        asm("p.lw %0,%2(%1!)" : "=r" (V3), "+r" (PtI) : "i" (4) : );
        asm("p.lh %0,%2(%1!)" : "=r" (Y), "+r" (PtI) : "r" (Off0) : );
        V10 = gap8_pack2(X, Y);
        asm("p.lw %0,%2(%1!)" : "=r" (V4), "+r" (PtI) : "i" (4) : );
        asm("p.lw %0,%2(%1!)" : "=r" (V5), "+r" (PtI) : "i" (4) : );
        asm("p.lh %0,%2(%1!)" : "=r" (X), "+r" (PtI) : "r" (Off0) : );
        asm("p.lw %0,%2(%1!)" : "=r" (V6), "+r" (PtI) : "i" (4) : );
        asm("p.lw %0,%2(%1!)" : "=r" (V7), "+r" (PtI) : "i" (4) : );
        asm("p.lh %0,%2(%1!)" : "=r" (Y), "+r" (PtI) : "r" (Off0) : );
        V11 = gap8_pack2(X, Y);
#else
        V0 = *PtI++;
        ...
        {
#ifdef ASM_OPT1
            asm VOL("p.lw %0,%2(%1!)":"=r" (V8), "+r" (PtI):"i" (4):"memory");
            asm VOL("p.lw %0,%2(%1!)":"=r" (V9), "+r" (PtI):"i" (4):"memory");
            asm VOL("p.lh %0,%2(%1!)":"=r" (V12), "+r" (PtI):"r" (Off0):"memory");
#else
            V8 = *PtI++;
            V9 = *PtI++;
            V12 = *PtI;
...

{
    ...
    for (unsigned int w = Wo_F; w < Wo_L; w++)
    {
        ...
        asm VOL("p.lw %0,%2(%1!)":"=r" (V0), "+r" (PtI):"i" (4):"memory");
        asm VOL("p.lw %0,%2(%1!)":"=r" (V1), "+r" (PtI):"i" (4):"memory");
        asm VOL("p.lh %0,%2(%1!)" :"=r" (X),  "+r" (PtI):"r" (Off0):"memory");
        asm VOL("p.lw %0,%2(%1!)":"=r" (V2), "+r" (PtI):"i" (4):"memory");
        asm VOL("p.lw %0,%2(%1!)":"=r" (V3), "+r" (PtI):"i" (4):"memory");
        asm VOL("p.lh %0,%2(%1!)" :"=r" (Y),  "+r" (PtI):"r" (Off0):"memory");
        V10 = gap8_pack2(X, Y);
        asm VOL("p.lw %0,%2(%1!)":"=r" (V4), "+r" (PtI):"i" (4):"memory");
        asm VOL("p.lw %0,%2(%1!)":"=r" (V5), "+r" (PtI):"i" (4):"memory");
        asm VOL("p.lhu %0,%2(%1!)":"=r" (V11), "+r" (PtI):"r" (Off0):"memory");
#else
        V0 = *PtI++;
        V1 = *PtI++;
        X = *((short int *) PtI);
        ...
        for (unsigned int h = Ho_F; h < Ho_L; h++)
        {
            int S = *PtO << Norm;
#ifdef ASM_OPT1
            asm VOL("p.lw %0,%2(%1!)":"=r"(V6), "+r"(PtI):"i"(4):"memory");
            asm VOL("p.lw %0,%2(%1!)":"=r"(V7), "+r"(PtI):"i"(4):"memory");
            asm VOL("p.lh %0,%2(%1!)":"=r"(X),  "+r"(PtI):"r"(Off0):"memory");
...

{
    ...
    for (unsigned int h = Ho_F; h < Ho_L; h++)
    {
        for (unsigned int w = Wo_F; w < Wo_L; w++)
        {
            ...
            asm VOL("p.lw %0,%2(%1!)":"=r"(Iv1), "+r"(PtI):"i"(4):"memory");
            asm VOL("p.lh %0,%2(%1!)":"=r"(I), "+r"(PtI):"r"(2*W-2*(Fw-1)):"memory");
            Acc = gap8_sumdotp2(Iv0, Cv8, Acc);
            Acc = gap8_sumdotp2(Iv1, Cv9, Acc);
            Acc += I * C4;
            Acc = gap8_clip(gap8_roundnorm_reg(Acc, Norm), 15);
            asm VOL("p.sh %1,%2(%0!)"  : "+r" (PtO) : "r" (Acc), "i" (2) : "memory");
#else
    ...
    for (unsigned int h = Ho_F; h < Ho_L; h++)
    {
        for (unsigned int w = Wo_F; w < Wo_L; w++)
        {
            ...
            for (unsigned int i = 0; i < Fh; i++)
            {
                ...
                {
                    v2s Cv, Iv;
                    asm VOL("p.lw %0,%2(%1!)" : "=r" (Cv), "+r" (PtC) : "i"   (4) : "memory");
                    asm VOL("p.lw %0,%2(%1!)" : "=r" (Iv), "+r" (PtI) : "i"   (4) : "memory");
                    Acc = gap8_sumdotp2(Iv, Cv, Acc);
                }
                asm VOL("p.lh %0,%2(%1!)" : "=r" (C), "+r" (PtC) : "i"   (2) : "memory");
                asm VOL("p.lh %0,%2(%1!)" : "=r" (I), "+r" (PtI) : "r"   (2*W-2*(Fw-1)) : "memory");
                Acc += I * C;
            }
            Acc = gap8_clip(gap8_roundnorm_reg(Acc, Norm), 15);
...
)
{
    ...
    for (unsigned int h = Ho_F; h < Ho_L; h++)
    {
        for (unsigned int w = Wo_F; w < Wo_L; w++)
        {
            int Acc = *PtO << Norm;
#ifdef ASM_OPT
            short int *PtI = In + (h * StrideY - PadT) * W +  (w * StrideX - PadL);
            for (unsigned int i = 0; i < Fh; i++)
            {
                int C, I;
                for (unsigned int j = 0; j < (Fw / 2); j++)
...

{
    ...
    else
    {
        ...
        BaseInFeature = Arg->BaseInFeature;
        BaseOutFeature = Arg->BaseOutFeature;
...
void KerParConv3x1Stride1x1_fp(KerParConv_fp_T *Arg)

{
    ...
    if (TotalInFeatures < 0)
    {
        for (unsigned int of = First; of < Last; of++)
        {
            ...
            KerConv3x1Stride1x1_Body_fp(in, out, filter, W, H, Wo, Wo_F, Wo_L, Ho, Ho_F, Ho_L, PadIn, Norm);
            if ((int)PadIn) KerConv3x1BorderStrideNx1_fp(in, out, filter, W, H, Wo, Wo_F, Wo_L, Ho, Ho_F, Ho_L, 1, PadIn, PadIn, Norm);
        }
    }
    else
    {
        ...
        for (unsigned int of = First; of < Last; of++)
        {
            for (unsigned int If = 0; If < InFeatures; If++)
            {
                short int *in = In + W * H * If, *filter = Filter + FSx * FSy * (TotalInFeatures * of + BaseInFeature + If), *out = Out + Wo * Ho * (BaseOutFeature + of);
                KerConv3x1Stride1x1_Body_fp(in, out, filter, W, H, Wo, Wo_F, Wo_L, Ho, Ho_F, Ho_L, PadIn, Norm);
                if ((int)PadIn) KerConv3x1BorderStrideNx1_fp(in, out, filter, W, H, Wo, Wo_F, Wo_L, Ho, Ho_F, Ho_L, 1, PadIn, PadIn, Norm);
            }
        }
...
void KerParConv3x1Stride2x1_fp(KerParConv_fp_T *Arg)

{
    ...
    if (TotalInFeatures < 0)
    {
        ...
        {
            short int *in = In + W * H * of, *filter = Filter + FSx * FSy * of, *out = Out + Wo * Ho * of;
            KerConv3x1Stride2x1_Body_fp(in, out, filter, W, H, Wo, Wo_F, Wo_L, Ho, Ho_F, Ho_L, PadIn, Norm);
            if ((int)PadIn) KerConv3x1BorderStrideNx1_fp(in, out, filter, W, H, Wo, Wo_F, Wo_L, Ho, Ho_F, Ho_L, 2, PadIn, PadIn, Norm);
        }
    }
    else
    {
...
void KerParConv1x3Stride1x1_fp(KerParConv_fp_T *Arg)

{
    ...
    if (TotalInFeatures < 0)
    {
        ...
        {
            short int *in = In + W * H * of, *filter = Filter + FSx * FSy * of, *out = Out + Wo * Ho * of;
            KerConv1x3Stride1x1_Body_fp(in, out, filter, W, H, Wo, Wo_F, Wo_L, Ho, Ho_F, Ho_L, PadIn, Norm);
            if ((int)PadIn) KerConv1x3BorderStride1xN_fp(in, out, filter, W, H, Wo, Wo_F, Wo_L, Ho, Ho_F, Ho_L, 1, PadIn, PadIn, Norm);
        }
    }
    else
    {
...
void KerParConv1x3Stride1x2_fp(KerParConv_fp_T *Arg)

{
    ...
    if (TotalInFeatures < 0)
    {
        ...
        {
            short int *in = In + W * H * of, *filter = Filter + FSx * FSy * of, *out = Out + Wo * Ho * of;
            KerConv1x3Stride1x2_Body_fp(in, out, filter, W, H, Wo, Wo_F, Wo_L, Ho, Ho_F, Ho_L, PadIn, Norm);
            if ((int)PadIn) KerConv1x3BorderStride1xN_fp(in, out, filter, W, H, Wo, Wo_F, Wo_L, Ho, Ho_F, Ho_L, 2, PadIn, PadIn, Norm);
        }
    }
    else
    {
...
void KerParConv5x1Stride1x1_fp(KerParConv_fp_T *Arg)

{
    ...
    if (TotalInFeatures < 0)
    {
        ...
        {
            short int *in = In + W * H * of, *filter = Filter + FSx * FSy * of, *out = Out + Wo * Ho * of;
            KerConv5x1Stride1x1_Body_fp(in, out, filter, W, H, Wo, Wo_F, Wo_L, Ho, Ho_F, Ho_L, PadIn, Norm);
            if ((int)PadIn) KerConv5x1BorderStrideNx1_fp(in, out, filter, W, H, Wo, Wo_F, Wo_L, Ho, Ho_F, Ho_L, 1, PadIn, PadIn, Norm);
        }
    }
    else
    {
...
void KerParConv5x1Stride2x1_fp(KerParConv_fp_T *Arg)

{
    ...
    if (TotalInFeatures < 0)
    {
        ...
        {
            short int *in = In + W * H * of, *filter = Filter + FSx * FSy * of, *out = Out + Wo * Ho * of;
            KerConv5x1Stride2x1_Body_fp(in, out, filter, W, H, Wo, Wo_F, Wo_L, Ho, Ho_F, Ho_L, PadIn, Norm);
            if ((int)PadIn) KerConv5x1BorderStrideNx1_fp(in, out, filter, W, H, Wo, Wo_F, Wo_L, Ho, Ho_F, Ho_L, 2, PadIn, PadIn, Norm);
        }
    }
    else
    {
...
void KerParConv1x5Stride1x1_fp(KerParConv_fp_T *Arg)

{
    ...
    if (TotalInFeatures < 0)
    {
        ...
        {
            short int *in = In + W * H * of, *filter = Filter + FSx * FSy * of, *out = Out + Wo * Ho * of;
            KerConv1x5Stride1x1_Body_fp(in, out, filter, W, H, Wo, Wo_F, Wo_L, Ho, Ho_F, Ho_L, PadIn, Norm);
            if ((int)PadIn) KerConv1x5BorderStride1xN_fp(in, out, filter, W, H, Wo, Wo_F, Wo_L, Ho, Ho_F, Ho_L, 1, PadIn, PadIn, Norm);
        }
    }
    else
    {
...
void KerParConv1x5Stride1x2_fp(KerParConv_fp_T *Arg)

{
    ...
    if (TotalInFeatures < 0)
    {
        ...
        {
            short int *in = In + W * H * of, *filter = Filter + FSx * FSy * of, *out = Out + Wo * Ho * of;
            KerConv1x5Stride1x2_Body_fp(in, out, filter, W, H, Wo, Wo_F, Wo_L, Ho, Ho_F, Ho_L, PadIn, Norm);
            if ((int)PadIn) KerConv1x5BorderStride1xN_fp(in, out, filter, W, H, Wo, Wo_F, Wo_L, Ho, Ho_F, Ho_L, 2, PadIn, PadIn, Norm);
        }
    }
    else
    {
...
void KerParConvNxMStrideSxSy_fp(KerParConv_fp_T *Arg)

{
    ...
    if (TotalInFeatures < 0)
    {
        ...
        {
            short int *in = In + W * H * of, *filter = Filter + FSx * FSy * of, *out = Out + Wo * Ho * of;
            KerConvNxMStrideSxSy_Body_fp(in, out, filter, FSx, FSy, W, H, Wo, Wo_F, Wo_L, Ho, Ho_F, Ho_L, Sx, Sy, PadIn, Norm);
            if ((int)PadIn) KerConvNxMStrideSxSy_Border_fp(in, out, filter, FSx, FSy, W, H, Wo, Wo_F, Wo_L, Ho, Ho_F, Ho_L, Sx, Sy, PadIn, PadIn, Norm);
        }
    }
    else
    {
...
void KerParConv3x1Stride1x1_fps(KerParConv_fps_T *Arg)

{
    ...
    if (TotalInFeatures < 0)
    {
        for (unsigned int of = First; of < Last; of++)
        {
            ...
            KerConv3x1Stride1x1_Body_fps(in, out, filter, W, H, Wo, Wo_F, Wo_L, Ho, Ho_F, Ho_L, PadIn, Norm);
            if ((int)PadIn) KerConv3x1BorderStrideNx1_fps(in, out, filter, W, H, Wo, Wo_F, Wo_L, Ho, Ho_F, Ho_L, 1, PadIn, PadIn, Norm);
        }
    }
    else
    {
        ...
        for (unsigned int of = First; of < Last; of++)
            for (unsigned int If = 0; If < InFeatures; If++)
            {
                signed char *in = In + W * H * If, *filter = Filter + FSx * FSy * (TotalInFeatures * of + BaseInFeature + If), *out = Out + Wo * Ho * (BaseOutFeature + of);
                KerConv3x1Stride1x1_Body_fps(in, out, filter, W, H, Wo, Wo_F, Wo_L, Ho, Ho_F, Ho_L, PadIn, Norm);
                if ((int)PadIn) KerConv3x1BorderStrideNx1_fps(in, out, filter, W, H, Wo, Wo_F, Wo_L, Ho, Ho_F, Ho_L, 1, PadIn, PadIn, Norm);
            }
    }
...
void KerParConv3x1Stride2x1_fps(KerParConv_fps_T *Arg)

{
    ...
    if (TotalInFeatures < 0)
    {
        ...
        {
            signed char *in = In + W * H * of, *filter = Filter + FSx * FSy * of, *out = Out + Wo * Ho * of;
            KerConv3x1Stride2x1_Body_fps(in, out, filter, W, H, Wo, Wo_F, Wo_L, Ho, Ho_F, Ho_L, PadIn, Norm);
            if ((int)PadIn) KerConv3x1BorderStrideNx1_fps(in, out, filter, W, H, Wo, Wo_F, Wo_L, Ho, Ho_F, Ho_L, 2, PadIn, PadIn, Norm);
        }
    }
    else
    {
...
void KerParConv1x3Stride1x1_fps(KerParConv_fps_T *Arg)

{
    ...
    if (TotalInFeatures < 0)
    {
        ...
        {
            signed char *in = In + W * H * of, *filter = Filter + FSx * FSy * of, *out = Out + Wo * Ho * of;
            KerConv1x3Stride1x1_Body_fps(in, out, filter, W, H, Wo, Wo_F, Wo_L, Ho, Ho_F, Ho_L, PadIn, Norm);
            if ((int)PadIn) KerConv1x3BorderStride1xN_fps(in, out, filter, W, H, Wo, Wo_F, Wo_L, Ho, Ho_F, Ho_L, 1, PadIn, PadIn, Norm);
        }
    }
    else
    {
...
void KerParConv1x3Stride1x2_fps(KerParConv_fps_T *Arg)

{
    ...
    if (TotalInFeatures < 0)
    {
        ...
        {
            signed char *in = In + W * H * of, *filter = Filter + FSx * FSy * of, *out = Out + Wo * Ho * of;
            KerConv1x3Stride1x2_Body_fps(in, out, filter, W, H, Wo, Wo_F, Wo_L, Ho, Ho_F, Ho_L, PadIn, Norm);
            if ((int)PadIn) KerConv1x3BorderStride1xN_fps(in, out, filter, W, H, Wo, Wo_F, Wo_L, Ho, Ho_F, Ho_L, 2, PadIn, PadIn, Norm);
        }
    }
    else
    {
...
void KerParConv5x1Stride1x1_fps(KerParConv_fps_T *Arg)

{
    ...
    if (TotalInFeatures < 0)
    {
        ...
        {
            signed char *in = In + W * H * of, *filter = Filter + FSx * FSy * of, *out = Out + Wo * Ho * of;
            KerConv5x1Stride1x1_Body_fps(in, out, filter, W, H, Wo, Wo_F, Wo_L, Ho, Ho_F, Ho_L, PadIn, Norm);
            if ((int)PadIn) KerConv5x1BorderStrideNx1_fps(in, out, filter, W, H, Wo, Wo_F, Wo_L, Ho, Ho_F, Ho_L, 1, PadIn, PadIn, Norm);
        }
    }
    else
    {
...
void KerParConv5x1Stride2x1_fps(KerParConv_fps_T *Arg)

{
    ...
    if (TotalInFeatures < 0)
    {
        ...
        {
            signed char *in = In + W * H * of, *filter = Filter + FSx * FSy * of, *out = Out + Wo * Ho * of;
            KerConv5x1Stride2x1_Body_fps(in, out, filter, W, H, Wo, Wo_F, Wo_L, Ho, Ho_F, Ho_L, PadIn, Norm);
            if ((int)PadIn) KerConv5x1BorderStrideNx1_fps(in, out, filter, W, H, Wo, Wo_F, Wo_L, Ho, Ho_F, Ho_L, 2, PadIn, PadIn, Norm);
        }
    }
    else
    {
...
void KerParConv1x5Stride1x1_fps(KerParConv_fps_T *Arg)

{
    ...
    if (TotalInFeatures < 0)
    {
        ...
        {
            signed char *in = In + W * H * of, *filter = Filter + FSx * FSy * of, *out = Out + Wo * Ho * of;
            KerConv1x5Stride1x1_Body_fps(in, out, filter, W, H, Wo, Wo_F, Wo_L, Ho, Ho_F, Ho_L, PadIn, Norm);
            if ((int)PadIn) KerConv1x5BorderStride1xN_fps(in, out, filter, W, H, Wo, Wo_F, Wo_L, Ho, Ho_F, Ho_L, 1, PadIn, PadIn, Norm);
        }
    }
    else
    {
...
void KerParConv1x5Stride1x2_fps(KerParConv_fps_T *Arg)

{
    ...
    if (TotalInFeatures < 0)
    {
        ...
        {
            signed char *in = In + W * H * of, *filter = Filter + FSx * FSy * of, *out = Out + Wo * Ho * of;
            KerConv1x5Stride1x2_Body_fps(in, out, filter, W, H, Wo, Wo_F, Wo_L, Ho, Ho_F, Ho_L, PadIn, Norm);
            if ((int)PadIn) KerConv1x5BorderStride1xN_fps(in, out, filter, W, H, Wo, Wo_F, Wo_L, Ho, Ho_F, Ho_L, 2, PadIn, PadIn, Norm);
        }
    }
    else
    {
...
void KerParConvNxMStrideSxSy_fps(KerParConv_fps_T *Arg)

{
    ...
    if (TotalInFeatures < 0)
    {
        ...
        {
            signed char *in = In + W * H * of, *filter = Filter + FSx * FSy * of, *out = Out + Wo * Ho * of;
            KerConvNxMStrideSxSy_Body_fps(in, out, filter, FSx, FSy, W, H, Wo, Wo_F, Wo_L, Ho, Ho_F, Ho_L, Sx, Sy, PadIn, Norm);
            if ((int)PadIn) KerConvNxMStrideSxSy_Border_fps(in, out, filter, FSx, FSy, W, H, Wo, Wo_F, Wo_L, Ho, Ho_F, Ho_L, Sx, Sy, PadIn, PadIn, Norm);
        }
    }
    else
    {
...
/*
	...
	KerConv3x1Stride1x1_fp
		|------	KerConv3x1Stride1x1_Body_fp
		|------	KerConv3x1StrideNx1_Border_fp
	KerConv3x1Stride2x1_fp
		|------	KerConv3x1Stride2x1_Body_fp
		|------	KerConv3x1StrideNx1_Border_fp
	KerConv1x3Stride1x1_fp
		|------	KerConv1x3Stride1x1_Body_fp
		|------	KerConv1x3Stride1xN_Border_fp
	KerConv1x3Stride1x2_fp
		|------	KerConv1x3Stride1x2_Body_fp
		|------	KerConv1x3Stride1xN_Border_fp
	...
	KerConv5x1Stride1x1_fp
		|------	KerConv5x1Stride1x1_Body_fp
		|------	KerConv5x1StrideNx1_Border_fp
	KerConv5x1Stride2x1_fp
		|------	KerConv5x1Stride2x1_Body_fp
		|------	KerConv5x1StrideNx1_Border_fp
	KerConv1x5Stride1x1_fp
		|------	KerConv1x5Stride1x1_Body_fp
		|------	KerConv1x5Stride1xN_Border_fp
	KerConv1x5Stride1x2_fp
		|------	KerConv1x5Stride1x2_Body_fp
		|------	KerConv1x5Stride1xN_Border_fp
...
void KerConv3x1Stride1x1_fp(KerConv_fp_T *Arg)

{
    ...
    if (First < Last)
    {
        KerConv3x1Stride1x1_Body_fp(In, Out, Filter, W, H, Wo, Wo_F, Wo_L, Ho, Ho_F, Ho_L, PadOrg, Norm);
        if ((int)PadIn) KerConv3x1BorderStrideNx1_fp(In, Out, Filter, W, H, Wo, Wo_F, Wo_L, Ho, Ho_F, Ho_L, Sx, PadIn, PadOrg, Norm);
    }
    gap8_waitbarrier(0);
}

void KerConv3x1Stride2x1_fp(KerConv_fp_T *Arg)

{
    ...
    if (First < Last)
    {
        KerConv3x1Stride2x1_Body_fp(In, Out, Filter, W, H, Wo, Wo_F, Wo_L, Ho, Ho_F, Ho_L, PadOrg, Norm);
        if ((int)PadIn) KerConv3x1BorderStrideNx1_fp(In, Out, Filter, W, H, Wo, Wo_F, Wo_L, Ho, Ho_F, Ho_L, Sx, PadIn, PadOrg, Norm);
    }
    gap8_waitbarrier(0);
}

void KerConv1x3Stride1x1_fp(KerConv_fp_T *Arg)

{
    ...
    if (First < Last)
    {
        KerConv1x3Stride1x1_Body_fp(In, Out, Filter, W, H, Wo, Wo_F, Wo_L, Ho, Ho_F, Ho_L, PadOrg, Norm);
        if ((int)PadIn) KerConv1x3BorderStride1xN_fp(In, Out, Filter, W, H, Wo, Wo_F, Wo_L, Ho, Ho_F, Ho_L, Sy, PadIn, PadOrg, Norm);
    }
    gap8_waitbarrier(0);
}

void KerConv1x3Stride1x2_fp(KerConv_fp_T *Arg)

{
    ...
    if (First < Last)
    {
        KerConv1x3Stride1x2_Body_fp(In, Out, Filter, W, H, Wo, Wo_F, Wo_L, Ho, Ho_F, Ho_L, PadOrg, Norm);
        if ((int)PadIn) KerConv1x3BorderStride1xN_fp(In, Out, Filter, W, H, Wo, Wo_F, Wo_L, Ho, Ho_F, Ho_L, Sy, PadIn, PadOrg, Norm);
    }
    gap8_waitbarrier(0);
}
...
void KerConv5x1Stride1x1_fp(KerConv_fp_T *Arg)

{
    ...
    if (First < Last)
    {
        KerConv5x1Stride1x1_Body_fp(In, Out, Filter, W, H, Wo, Wo_F, Wo_L, Ho, Ho_F, Ho_L, PadOrg, Norm);
        if ((int)PadIn) KerConv5x1BorderStrideNx1_fp(In, Out, Filter, W, H, Wo, Wo_F, Wo_L, Ho, Ho_F, Ho_L, Sx, PadIn, PadOrg, Norm);
    }
    gap8_waitbarrier(0);
}

void KerConv5x1Stride2x1_fp(KerConv_fp_T *Arg)

{
    ...
    if (First < Last)
    {
        KerConv5x1Stride2x1_Body_fp(In, Out, Filter, W, H, Wo, Wo_F, Wo_L, Ho, Ho_F, Ho_L, PadOrg, Norm);
        if ((int)PadIn) KerConv5x1BorderStrideNx1_fp(In, Out, Filter, W, H, Wo, Wo_F, Wo_L, Ho, Ho_F, Ho_L, Sx, PadIn, PadOrg, Norm);
    }
    gap8_waitbarrier(0);
}

void KerConv1x5Stride1x1_fp(KerConv_fp_T *Arg)

{
    ...
    if (First < Last)
    {
        KerConv1x5Stride1x1_Body_fp(In, Out, Filter, W, H, Wo, Wo_F, Wo_L, Ho, Ho_F, Ho_L, PadOrg, Norm);
        if ((int)PadIn) KerConv1x5BorderStride1xN_fp(In, Out, Filter, W, H, Wo, Wo_F, Wo_L, Ho, Ho_F, Ho_L, Sy, PadIn, PadOrg, Norm);
    }
    gap8_waitbarrier(0);
}

void KerConv1x5Stride1x2_fp(KerConv_fp_T *Arg)

{
    ...
    if (First < Last)
    {
        KerConv1x5Stride1x2_Body_fp(In, Out, Filter, W, H, Wo, Wo_F, Wo_L, Ho, Ho_F, Ho_L, PadOrg, Norm);
        if ((int)PadIn) KerConv1x5BorderStride1xN_fp(In, Out, Filter, W, H, Wo, Wo_F, Wo_L, Ho, Ho_F, Ho_L, Sy, PadIn, PadOrg, Norm);
    }
    gap8_waitbarrier(0);
}
...
void KerConvNxMStrideSxSy_fp(KerConv_fp_T *Arg)

{
    ...
    if (First < Last)
    {
        KerConvNxMStrideSxSy_Body_fp(In, Out, Filter, FSx, FSy, W, H, Wo, Wo_F, Wo_L, Ho, Ho_F, Ho_L, Sx, Sy, PadOrg, Norm);
        if ((int)PadIn) KerConvNxMStrideSxSy_Border_fp(In, Out, Filter, FSx, FSy, W, H, Wo, Wo_F, Wo_L, Ho, Ho_F, Ho_L, Sx, Sy, PadIn, PadOrg, Norm);
    }
    gap8_waitbarrier(0);
}
...
/*
	...
	KerConv3x1Stride1x1_fps
		|------	KerConv3x1Stride1x1_Body_fps
		|------	KerConv3x1StrideNx1_Border_fps
	KerConv3x1Stride2x1_fps
		|------	KerConv3x1Stride2x1_Body_fps
		|------	KerConv3x1StrideNx1_Border_fps
	KerConv1x3Stride1x1_fps
		|------	KerConv1x3Stride1x1_Body_fps
		|------	KerConv1x3Stride1xN_Border_fps
	KerConv1x3Stride1x2_fps
		|------	KerConv1x3Stride1x2_Body_fps
		|------	KerConv1x3Stride1xN_Border_fps
	...
	KerConv5x1Stride1x1_fps
		|------	KerConv5x1Stride1x1_Body_fps
		|------	KerConv5x1StrideNx1_Border_fps
	KerConv5x1Stride2x1_fps
		|------	KerConv5x1Stride2x1_Body_fps
		|------	KerConv5x1StrideNx1_Border_fps
	KerConv1x5Stride1x1_fps
		|------	KerConv1x5Stride1x1_Body_fps
		|------	KerConv1x5Stride1xN_Border_fps
	KerConv1x5Stride1x2_fps
		|------	KerConv1x5Stride1x2_Body_fps
		|------	KerConv1x5Stride1xN_Border_fps
...
void KerConv3x1Stride1x1_fps(KerConv_fps_T *Arg)

{
    ...
    if (First < Last)
    {
        KerConv3x1Stride1x1_Body_fps(In, Out, Filter, W, H, Wo, Wo_F, Wo_L, Ho, Ho_F, Ho_L, PadOrg, Norm);
        if ((int)PadIn) KerConv3x1BorderStrideNx1_fps(In, Out, Filter, W, H, Wo, Wo_F, Wo_L, Ho, Ho_F, Ho_L, Sx, PadIn, PadOrg, Norm);
    }
    gap8_waitbarrier(0);
}

void KerConv3x1Stride2x1_fps(KerConv_fps_T *Arg)

{
    ...
    if (First < Last)
    {
        KerConv3x1Stride2x1_Body_fps(In, Out, Filter, W, H, Wo, Wo_F, Wo_L, Ho, Ho_F, Ho_L, PadOrg, Norm);
        if ((int)PadIn) KerConv3x1BorderStrideNx1_fps(In, Out, Filter, W, H, Wo, Wo_F, Wo_L, Ho, Ho_F, Ho_L, Sx, PadIn, PadOrg, Norm);
    }
    gap8_waitbarrier(0);
}

void KerConv1x3Stride1x1_fps(KerConv_fps_T *Arg)

{
    ...
    if (First < Last)
    {
        KerConv1x3Stride1x1_Body_fps(In, Out, Filter, W, H, Wo, Wo_F, Wo_L, Ho, Ho_F, Ho_L, PadOrg, Norm);
        if ((int)PadIn) KerConv1x3BorderStride1xN_fps(In, Out, Filter, W, H, Wo, Wo_F, Wo_L, Ho, Ho_F, Ho_L, Sy, PadIn, PadOrg, Norm);
    }
    gap8_waitbarrier(0);
}

void KerConv1x3Stride1x2_fps(KerConv_fps_T *Arg)

{
    ...
    if (First < Last)
    {
        KerConv1x3Stride1x2_Body_fps(In, Out, Filter, W, H, Wo, Wo_F, Wo_L, Ho, Ho_F, Ho_L, PadOrg, Norm);
        if ((int)PadIn) KerConv1x3BorderStride1xN_fps(In, Out, Filter, W, H, Wo, Wo_F, Wo_L, Ho, Ho_F, Ho_L, Sy, PadIn, PadOrg, Norm);
    }
    gap8_waitbarrier(0);
}
...
void KerConv5x1Stride1x1_fps(KerConv_fps_T *Arg)

{
    ...
    if (First < Last)
    {
        KerConv5x1Stride1x1_Body_fps(In, Out, Filter, W, H, Wo, Wo_F, Wo_L, Ho, Ho_F, Ho_L, PadOrg, Norm);
        if ((int)PadIn) KerConv5x1BorderStrideNx1_fps(In, Out, Filter, W, H, Wo, Wo_F, Wo_L, Ho, Ho_F, Ho_L, Sx, PadIn, PadOrg, Norm);
    }
    gap8_waitbarrier(0);
}

void KerConv5x1Stride2x1_fps(KerConv_fps_T *Arg)

{
    ...
    if (First < Last)
    {
        KerConv5x1Stride2x1_Body_fps(In, Out, Filter, W, H, Wo, Wo_F, Wo_L, Ho, Ho_F, Ho_L, PadOrg, Norm);
        if ((int)PadIn) KerConv5x1BorderStrideNx1_fps(In, Out, Filter, W, H, Wo, Wo_F, Wo_L, Ho, Ho_F, Ho_L, Sx, PadIn, PadOrg, Norm);
    }
    gap8_waitbarrier(0);
}

void KerConv1x5Stride1x1_fps(KerConv_fps_T *Arg)

{
    ...
    if (First < Last)
    {
        KerConv1x5Stride1x1_Body_fps(In, Out, Filter, W, H, Wo, Wo_F, Wo_L, Ho, Ho_F, Ho_L, PadOrg, Norm);
        if ((int)PadIn) KerConv1x5BorderStride1xN_fps(In, Out, Filter, W, H, Wo, Wo_F, Wo_L, Ho, Ho_F, Ho_L, Sy, PadIn, PadOrg, Norm);
    }
    gap8_waitbarrier(0);
}

void KerConv1x5Stride1x2_fps(KerConv_fps_T *Arg)

{
    ...
    if (First < Last)
    {
        KerConv1x5Stride1x2_Body_fps(In, Out, Filter, W, H, Wo, Wo_F, Wo_L, Ho, Ho_F, Ho_L, PadOrg, Norm);
        if ((int)PadIn) KerConv1x5BorderStride1xN_fps(In, Out, Filter, W, H, Wo, Wo_F, Wo_L, Ho, Ho_F, Ho_L, Sy, PadIn, PadOrg, Norm);
    }
    gap8_waitbarrier(0);
}
...
void KerConvNxMStrideSxSy_fps(KerConv_fps_T *Arg)

{
    ...
    if (First < Last)
    {
        KerConvNxMStrideSxSy_Body_fps(In, Out, Filter, FSx, FSy, W, H, Wo, Wo_F, Wo_L, Ho, Ho_F, Ho_L, Sx, Sy, PadOrg, Norm);
        if ((int)PadIn) KerConvNxMStrideSxSy_Border_fps(In, Out, Filter, FSx, FSy, W, H, Wo, Wo_F, Wo_L, Ho, Ho_F, Ho_L, Sx, Sy, PadIn, PadOrg, Norm);
    }
    gap8_waitbarrier(0);
}
