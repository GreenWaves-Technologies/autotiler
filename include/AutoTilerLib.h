...
extern void AT_PrepareForTest(char *Name,
                    ...
                    int FScW, int FScH, int ConvStrideW, int ConvStrideH, v4s PadInp, int ConvDoReLU, int DoConv,
                    int FSpW, int FSpH, int PoolStrideW, int PoolStrideH, v4s PadInc, int PoolDoReLU, int DoPool,
                    int DoLinear,
                    int DoReLU,
                    int DoSoftMax,
                    int Norm,
